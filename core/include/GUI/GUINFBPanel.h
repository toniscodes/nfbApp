...
#ifndef GUINFBPANEL_H
#define GUINFBPANEL_H
...
class GUINFBPanel : public GUIElement
{
public:
    GUINFBPanel();
    GUINFBPanel(int xP, int yP, int panelItemSizeYP, int widthP, int heightP, int scrollBarWidthP, string toolTipText);
    GUINFBPanel(int xP, int yP, int panelItemSizeYP, int widthP, int heightP, int scrollBarWidthP, int zIndexP, string toolTipText);
    virtual ~GUINFBPanel();
